...
ThemeData buildSolarizedTheme({light: bool}) {
  ...
  return base.copyWith(
    ...
    textTheme: base.textTheme.copyWith(
      headline1: base.textTheme.headline1.copyWith(color: cs.onBackground),
      headline5: base.textTheme.headline5.copyWith(color: cs.onBackground),
      headline6: base.textTheme.headline6.copyWith(color: cs.onPrimary), // hijacked for AppBar
      bodyText1: base.textTheme.bodyText1.copyWith(color: cs.onSurface),
      bodyText2: base.textTheme.bodyText2.copyWith(color: cs.onBackground),
    ),
    */
  );
}
